	...
	<div class="carousel-inner">
		...
		<?php foreach($banners as $banner) : ?>
			...
			<div class="carousel-item <?php if($no <= 1) { echo "active"; } ?>">
				<img src="<?= base_url("img/$banner->photo") ?>" class="d-block w-100">
	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 text-center">
				<img src="<?= base_url('img/' . $sambutan->photo) ?>" class="img-thumbnail img-fluid">
			</div>
		</div>
	</div>
</div>
...
<!-- Jurusan -->
<div class="jumbotron jumbotron-fluid bg-cover jurusan mt-5" style="background-image: url(<?= base_url('img/' . $jurusan->photo) ?>)">
	<div class="container text-center">
		...
		<div class="row pt-3">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				...
				<h5 class="mt-2">Rekayasa Perangkat Lunak</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/marketing.svg') ?>" alt="">
				<h5 class="mt-2">APHP</h5>
			</div>
		</div>
	</div>
</div>
			...
			<?php foreach($berita as $b) : ?>
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
					<div class="card" style="width: 15rem; height: 24rem;">
						<img style="height:150px" src="<?= base_url('img/' . $b->photo) ?>" class="card-img-top">
						<div class="card-body">
